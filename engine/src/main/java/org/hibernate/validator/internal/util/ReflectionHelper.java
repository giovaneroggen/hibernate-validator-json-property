...
public final class ReflectionHelper {
	...
	public static String getPropertyName(Member member) {
		...
		if ( member instanceof Field ) {
			name = getPropertyOrJsonPropertyName( member );
		}
		if ( member instanceof Method ) {
			String methodName = getPropertyOrJsonPropertyName( member );
	...
	private static String getPropertyOrJsonPropertyName(Member member) {
		JsonProperty jsonProperty = jsonPropertyAnnotation( (AccessibleObject)member );
	...
	private static JsonProperty jsonPropertyAnnotation(AccessibleObject member) {
		JsonProperty property = null;
		String value = null;
		if ( member.isAnnotationPresent( JsonProperty.class ) &&
		   ( property = member.getAnnotation( JsonProperty.class ) ) != null &&
